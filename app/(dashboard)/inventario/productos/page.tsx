      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1 flex items-center gap-2">
            <Package size={16} />
            {stats.totalProductos} productos • {stats.totalStock} unidades en
            stock
          </p>
        </div>
              ...
              return (
                <tr key={producto.id} className="table-row-hover">
                  ...
                  <td>
                    <div className="flex items-center gap-2">
                      <span
                        className={`font-semibold ${stockBajo ? "text-red-600" : "text-slate-900"}`}
                      >
                        {producto.stock}
                      </span>
                      {stockBajo && (
                  ...
                  <td>
                    <span
                      className={`badge ${producto.active ? "badge-success" : "badge-neutral"}`}
                    >
