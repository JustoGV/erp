...
export default function EnPreparacion({ moduloNombre, moduloHref }: EnPreparacionProps) {
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center space-y-6 max-w-md mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
          {moduloNombre && moduloHref && (
            <Link href={moduloHref} className="btn btn-secondary">
              <ArrowLeft size={18} />
              Volver a {moduloNombre}
            </Link>
          )}
